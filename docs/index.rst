...
#. Start streaming live sports and ESPN content.

ESPN Activation Code Not Working?
---------------------------------

If you're having trouble activating your device, try these quick fixes:

* Make sure the activation code hasn't expired.
* Refresh the ESPN app to generate a new code.
* Enter the activation code exactly as displayed.
* Verify you're signed in with the correct ESPN or TV provider account.
